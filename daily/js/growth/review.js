// App Store review prompt — asked at delight moments only (3rd daily solve or
...
export function shouldRequestReview({ daily, promptedVersion, version = VERSION }) {
  ...
  if (!today?.solved) return false; // never on the back of a fail
  return daily.wins >= 3 || daily.streak >= 7;
}
